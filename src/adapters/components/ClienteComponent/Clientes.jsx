...
export default function Clientes() {
    ...
    const handleUpdate = async (e) => {
        e.preventDefault();
        try {
            await axios.patch(`http://localhost:8055/items/empresa/${selectedEmpresa.id}`, clientData, {
                // headers: {
                //     'Authorization': `Bearer ${localStorage.getItem("authToken")}`
                // }
            });
                    ...
                    <div className="modal-box w-11/12 max-w-5xl">
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4 py-4">
                            ...
                            <div className="modal-action col-span-2">
                                <button type="button" className="btn btn-error" onClick={handleCloseModal}>Cerrar</button>
                ...
                <dialog open className="modal">
                    <div className="modal-box w-11/12 max-w-5xl">
                        ...
                        <div className="modal-action">
                            <button className="btn btn-error" onClick={handleCloseModal}>Cerrar</button>
                        </div>
                    </div>
                </dialog>
            )}
